...
export const questions: Question[] = [
  ...
  // =============================================================================
  {
    ...
    options: [
      ...
      { value: 4, label: "Documented, shared, and actively guiding investment decisions" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 3, label: "Supportive — leadership backs AI initiatives but expects others to lead" },
  ...
  },
  {
    ...
    inputType: "radio",
    options: [
      { value: 1, label: "Leadership have conflicting views on AI — it shows in decisions and priorities" },
      { value: 2, label: "Some agreement on direction, but no shared priorities or plan" },
      { value: 3, label: "Broadly aligned on goals, but investment and accountability are still unclear" },
      { value: 4, label: "Aligned on priorities with clear ownership across the leadership team" },
      { value: 5, label: "Strongly aligned — leadership speaks with one voice and backs it with resources and action" },
    ] as ScoredOption[],
  },
  ...
  // =============================================================================
  {
    ...
    options: [
      ...
      { value: 2, label: "Mixed — reliable in some areas but significant gaps or inconsistencies elsewhere" },
  ...
  },
  {
    ...
    inputType: "radio",
    options: [
      { value: 1, label: "Not at all — teams work with disconnected data across spreadsheets and silos" },
      ...
      { value: 5, label: "Strong — data flows reliably across systems with minimal manual effort" },
    ] as ScoredOption[],
  },
  {
    id: "data-4",
  ...
  },
  {
    id: "data-5",
    pillarId: "data",
    text: "How well does your technology setup support AI-powered working?",
    category: "diagnostic",
    questionType: "maturity",
    inputType: "radio",
    options: [
      { value: 1, label: "Mostly legacy systems that make AI adoption difficult" },
      { value: 2, label: "Basic modern tools, but the tech setup creates friction for AI work" },
      { value: 3, label: "Cloud-based tools that could support AI use, but not set up for it" },
      { value: 4, label: "Our tech stack is AI-friendly — tools, integrations, and APIs work well together" },
      { value: 5, label: "Actively set up for AI — tools, data, and systems are designed to work with it" },
    ] as ScoredOption[],
  },
  ...
  },
  {
    ...
    inputType: "radio",
    options: [
      { value: 1, label: "Most avoid AI tools — there's little interest or active resistance" },
      { value: 2, label: "A few individuals experiment, but use is isolated and not spreading" },
      { value: 3, label: "Common tools are in use, but capability varies widely across teams" },
      { value: 4, label: "Most of the team regularly uses AI as part of how they work" },
      { value: 5, label: "AI is deeply embedded — the team designs how it's used and pushes what's possible" },
    ] as ScoredOption[],
  },
  {
    id: "people-5",
    pillarId: "people",
    text: "Does your organisation have the AI capability it needs?",
    category: "diagnostic",
    questionType: "maturity",
    inputType: "radio",
    options: [
      { value: 1, label: "No AI capability in-house — and no clear plan to build it" },
      { value: 2, label: "Significant gaps — we're aware but haven't addressed them" },
      { value: 3, label: "Some capability exists, but we rely heavily on a few individuals or external support" },
      { value: 4, label: "Solid capability in-house, with a clear plan to close remaining gaps" },
      { value: 5, label: "Strong, distributed AI expertise — and we actively invest in growing it" },
    ] as ScoredOption[],
  },
  ...
  // =============================================================================
  {
    ...
    options: [
      ...
      { value: 5, label: "AI is embedded in key workflows — usage is tracked, refined, and expanding" },
    ] as ScoredOption[],
  },
  {
    id: "process-2",
    pillarId: "process",
    text: "How does your organisation manage AI tool adoption?",
    category: "diagnostic",
    questionType: "maturity",
    inputType: "radio",
    options: [
      { value: 1, label: "No governance — individuals use whatever they find" },
      { value: 2, label: "We know some tools are being used, but there's no guidance or standards" },
      { value: 3, label: "Informal guidelines or a recommended toolset, but inconsistently applied" },
      { value: 4, label: "Clear policies and a defined toolset used consistently across the team" },
      { value: 5, label: "Formal governance — approved tools, usage guidelines, and regular review cycles" },
    ] as ScoredOption[],
  },
  {
    id: "process-3",
  ...
  },
  {
    id: "process-5",
    pillarId: "process",
    text: "How does your organisation respond to new AI opportunities?",
    category: "diagnostic",
    questionType: "maturity",
    inputType: "radio",
    options: [
      { value: 1, label: "Slowly — new ideas face resistance or get lost in process" },
      { value: 2, label: "Cautiously — we're open to it, but progress takes months" },
      { value: 3, label: "Selectively — we can move quickly on some things but get stuck on others" },
      { value: 4, label: "Actively — we have a clear pathway for piloting and adopting new tools" },
      { value: 5, label: "Proactively — we seek out opportunities and have fast feedback loops to test and decide" },
    ] as ScoredOption[],
  },
